variable "req_rg_name" {
  type        = string
  description = "Resource Group Name"
}

variable "req_rg_location" {
  type        = string
  description = "Resource Group Location"
}

variable "req_vnet_info" {
  type = object({
    vnet_name          = string
...
variable "req_nsg_name" {
  type        = string
  description = "Network Security Group Name"
}

variable "req_nsg_rules_info" {
  type = list(object({
...
variable "req_load_balancer_info" {
  type = object({
    lb_name                    = string
...
variable "req_autoscale_profile_info" {
  type = list(object({
